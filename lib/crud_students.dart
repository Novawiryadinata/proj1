...
//               ),
//               value: selectedKelas ??
//                   defaultKelas, // Ensure a non-null value is used
          ...
          Padding(
            ...
            child: DropdownButtonFormField<String>(
              ...
              onChanged: (String? newValue) {
                setState(() {
                  selectedKelas = newValue!;
                  studentKelas = newValue; // Update studentKelas
                  kelasController.text = newValue;
                });
              },
              items: <String>['A', 'B', 'C', 'D']
            ...
            children: <Widget>[
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                  ...
                  shape: RoundedRectangleBorder(
                    borderRadius:
                        BorderRadius.circular(18), // Rounded button shape
                  ),
                ),
                onPressed: () {
                  createData();
                ...
                child: Text("Create"), // Button label
              ),
            ],
          ),
          Expanded(
