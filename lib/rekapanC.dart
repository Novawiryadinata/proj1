...
class RekapanCApp extends StatefulWidget {
  @override
  _RekapanCAppState createState() => _RekapanCAppState();
}

class _RekapanCAppState extends State<RekapanCApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Attendance List for Kelas C'),
        leading: IconButton(
...
class StudentListScreen extends StatelessWidget {
  final String kelasFilter = 'C'; // The class to filter by
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (groupedByDate.isEmpty) {
          return Center(
            child: Text('No attendance for Kelas C'),
          );
        }
