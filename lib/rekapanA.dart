...
class RekapanAApp extends StatefulWidget {
  @override
  _RekapanAAppState createState() => _RekapanAAppState();
}

class _RekapanAAppState extends State<RekapanAApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Attendance List for Kelas A'),
        leading: IconButton(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (groupedByDate.isEmpty) {
          return Center(
            child: Text('No attendance for Kelas A'),
          );
        }
